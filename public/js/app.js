 ...
 * UI Atualizada com layout profissional
 */
...
// 🖥️ UI — ATUALIZADA PARA NOVO LAYOUT
const UI = {
...
const Engine = {
    ...
    init() {
        ...
        UI.log('Conectando ao WebSocket...', 'info');
        WS.connect();
